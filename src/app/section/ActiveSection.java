...
public class ActiveSection extends VBox {
    private Controller ctr = new Controller();

    public ActiveSection(ArrayList<Todo> todos) {
        ...
        ctr.addTodosToListView(1, todoListView, todos);
        ...
        addTodoInput.setOnAction(e -> {
            ctr.addNewTodo(1, todos, todoListView, addTodoInput);
        });
